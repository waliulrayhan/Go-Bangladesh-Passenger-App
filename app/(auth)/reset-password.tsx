        ...
        <View style={styles.content}>
                ...
                <View style={styles.passwordRequirements}>
                  ...
                  <View style={styles.requirement}>
                    <Ionicons 
                      ...
                      size={16} 
                      color={newPassword === confirmPassword && newPassword ? COLORS.success : COLORS.gray[400]} 
                    />
                    <Text style={[
                      styles.requirementText,
          ...
          <Animated.View entering={FadeInUp.duration(800).delay(400)} style={styles.helpSection}>
            <Text style={styles.helpNote}>
              Make sure to remember your new password. You'll use it to login to your account.
            </Text>
          </Animated.View>
        </View>
      </SafeAreaView>
