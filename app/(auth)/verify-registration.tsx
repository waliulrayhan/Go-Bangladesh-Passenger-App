...
export default function VerifyRegistration() {
  ...
  const { isLoading, verifyOTP, registerUser, sendOTP } = useAuthStore();
  ...
  const handleVerify = async () => {
    ...
    try {
      // Verify OTP
      const isValid = await verifyOTP(params.mobile, otpString);
  ...
  const handleResendOTP = async () => {
    ...
    try {
      const sent = await sendOTP(params.mobile);
