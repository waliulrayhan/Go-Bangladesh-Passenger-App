...
export const GoBangladeshLogo: React.FC<GoBangladeshLogoProps> = ({ 
  size = 24, 
  style,
  color1 = '#f7941d', // Orange color from your SVG
  color2 = '#5995f7'  // Blue color from your SVG
}) => {
